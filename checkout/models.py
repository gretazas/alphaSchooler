...
class Order(models.Model):
    ...
    phone_number = models.CharField(max_length=80, null=False, blank=False)
    postcode = models.CharField(max_length=80, null=True, blank=True)
    ...
    def update_total(self):
        """ Each time a line item is added: update grand total """
