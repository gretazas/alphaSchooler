...
function handleTabletChange(mediaQuery) {
    ...
    if (mediaQuery.matches) {
        ...
        <div class="col-sm-12 text-center card-body ml-5">
            <div class="row w-50 mx-5 d-flex align-items-center justify-content-center card"><a>&nbsp; &nbsp; Copies/ Diaries<i class="fa-solid fa-book mx-3"></i></a></div>
            ...
            <div class="row w-50 mx-5 d-flex align-items-center justify-content-center card"><a>Folders<img src="/media/folder.png" style="height:30px;width:30px;padding-left:10px;"></a></div>
    </div>`
    }
}
